...
INSERT INTO repairshop_repair_orders (ro_number, customer_id, item_id, technician_id, problem_description, labor_cost, warranty_days, priority, status) VALUES
  ('RO-8921', 1, 1, 1, 'Brake noise on braking', 500, 30, 'high', 'invoiced'),
  ('RO-8920', 2, 2, 2, 'Cracked screen', 0, 30, 'normal', 'in_progress'),
  ('RO-8919', 3, 3, NULL, 'Not cooling', 0, 0, 'low', 'requested'),
  ('RO-8917', 4, 4, 1, 'Engine check light', 800, 90, 'urgent', 'closed'),
  ('RO-8912', 5, 5, 2, 'Not draining', 0, 0, 'normal', 'cancelled'),
  ('RO-8916', 1, 1, 1, 'Brake fluid top-up', 250, 30, 'normal', 'completed'),
  ('RO-8915', 2, 2, 2, 'Battery replacement', 600, 90, 'normal', 'invoiced');
